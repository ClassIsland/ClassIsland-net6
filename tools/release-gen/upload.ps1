...
foreach ($artifact in $artifacts){
    ...
    $downloadInfo = @{
        ...
        "ArchiveDownloadUrls" = @{
            "main" = "https://get.classisland.tech/d/ClassIsland-Ningbo-S3/classisland/disturb-net6/${version}/$($artifact.Name)"
    ...
    $uploadJobs += Start-ThreadJob -Name $artifact.FullName -StreamingHost $Host -ScriptBlock {
        ...
        UploadFile $inputs.artifact.FullName "ClassIsland-Ningbo-S3/classisland/disturb-net6/$($inputs.version)/"
...
$globalIndex.Versions.Add(@{
    ...
    VersionInfoUrl = "https://get.classisland.tech/d/ClassIsland-Ningbo-S3/classisland/disturb-net6/${version}/index.json"
})
